...
export const ANTIGRAVITY_PUBLIC_MODELS = Object.freeze([
  ...
  { id: "gemini-3.7-flash-high", name: "Gemini 3.7 Flash (High)", ...GEMINI_36_FLASH_BASE },
  { id: "gemini-3.7-flash-medium", name: "Gemini 3.7 Flash (Medium)", ...GEMINI_36_FLASH_BASE },
  { id: "gemini-3.7-flash-low", name: "Gemini 3.7 Flash (Low)", ...GEMINI_36_FLASH_BASE },
