export default {
  ...
  // Live-verified 2026-09-11 by probing /v2/chat/completions with each id.
  // 11102 "service info not found" = the gateway does not serve it: dropped.
  // Ids present on the gateway but missing here were added.
  models: [
