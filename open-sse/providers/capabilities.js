...
export const MODEL_CAPABILITIES = {
  ...
  // No PATTERN covers "muse*", so without these exact entries the capability
  // resolver falls to the safe floor: reasoning:false (applyThinking then STRIPS
...
export const PROVIDER_CAPABILITIES = {
  ...
  // CodeBuddy.cn — authoritative per-model metadata from the gateway's /v3/config
  ...
  "codebuddy-cn": {
    ...
    "glm-5.3-flash":      { vision: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: false, contextWindow: 1000000, maxOutput: 32000 },
    ...
    "minimax-m3-pay":     { vision: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: false, contextWindow: 512000, maxOutput: 128000 },
    ...
    "hy3-preview-agent":  { vision: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: false, contextWindow: 192000, maxOutput: 64000 },
  ...
  // CodeBuddy intl is NOT a copy of the CN catalog. Live probes on 2026-09-11
  // (POST /v2/chat/completions per id) show the intl gateway drops most older
  // GLM/MiniMax/DeepSeek ids and serves GPT ids that CN refuses. Keep this map
  // in lockstep with registry/codebuddy-intl.js only.
  "codebuddy-intl": {
    "glm-5.3":            { vision: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: false, contextWindow: 1000000, maxOutput: 48000 },
    "glm-5.2":            { vision: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: false, contextWindow: 1000000, maxOutput: 48000 },
    "glm-5.1":            { vision: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: false, contextWindow: 200000, maxOutput: 48000 },
    ...
    "hy4-preview-f":      { vision: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: false, contextWindow: 1000000, maxOutput: 64000 },
    "hy3":                { vision: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: false, contextWindow: 192000, maxOutput: 64000 },
    // v4.1-flash is the exception to "intl drops DeepSeek": live 200 on both gateways.
    "deepseek-v4.1-flash": { vision: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: false, contextWindow: 1000000, maxOutput: 50000 },
    // GPT ids are intl-only; CN answers 11102 "only available for authorized users".
    "gpt-6-astra":        { vision: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: false, contextWindow: 400000, maxOutput: 128000 },
    "gpt-5.6-luna":       { vision: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: false, contextWindow: 400000, maxOutput: 128000 },
