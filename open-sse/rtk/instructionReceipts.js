...
const __E = loadEngine("instructionReceipts") ?? {};

export const createReceipt = __E.createReceipt ?? (() => ({}));
export const recordInjectorResult = __E.recordInjectorResult ?? (() => {});
export const summarizeReceipt = __E.summarizeReceipt ?? (() => ({}));
