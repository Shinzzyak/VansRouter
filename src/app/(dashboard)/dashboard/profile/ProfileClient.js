...
export default function ProfileClient({ initialSettings }) {
  ...
  const handleExportDatabase = async (password) => {
    ...
    try {
      ...
      anchor.href = url;
      anchor.download = `Vans-backup-${stamp}.json`;
  ...
  const yydsEnabled = settings.yydsEnabled === true;
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <Input id="profile-oidc-issuer"
                  placeholder="https://auth.example.com/application/o/Vans/"
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:items-end">
              ...
              <div className="flex-1">
                ...
                <Input
                  type="password"
                  placeholder="eyJ… (account JWT — needed to create inboxes)"
                  value={yydsJwt}
            ...
            {settings?.yydsJwtConfigured && (
              <p className="text-xs text-green-500">JWT configured — inbox creation available.</p>
            )}
          </div>
        </Card>
