...
import { getPasskeys, createPasskey, updatePasskeyCounter, deletePasskey } from "@/lib/db/repos/passkeysRepo.js";
 ...
 */
export function getRpConfig(request) {
  ...
  if (rpId === "127.0.0.1" || rpId === "::1" || rpId === "[::1]") rpId = "localhost";
  return { rpId, origin };
}
