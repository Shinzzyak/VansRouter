...
# submit dengan email yang PASTI sudah terdaftar (belalanggita95@sintec.my.id dari run pertama)
state = '["$undefined","$K1"]'
files = {
    "1_device_fingerprint": (None, fp),
    "1_timezone": (None, "Asia/Jakarta"),
    "1_next": (None, ""),
    "1_email": (None, "belalanggita95@sintec.my.id"),
    "1_password": (None, "Test12345!"),
    "1_invite_code": (None, ""),
    "0": (None, state),
}
